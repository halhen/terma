...
static struct config_t config = {
    /* Initial size of terminal */
    .cols       = 80,
    .rows       = 24,

    .font       = "-*-*-medium-r-*-*-*-120-75-75-*-60-*-*",
    .bold_font  = "-*-*-medium-r-*-*-*-120-75-75-*-60-*-*",

    /* Number of characters between tabs */
    .tabsize    = 8,

    /* Number of times per second that the terminal window is repainted */
    .HZ         = 60,  /* Respond quickly at user input */
    .HZ_passive = 15,  /* ... but slow down when there's none */

    /* Time between on / off for blinking elements */
    .blink_delay={ .tv_sec  = 0,
                   .tv_usec = 600000 },

    /* Background Color Erase: if true, cells are erased with the current
     * background color, else they are erased with the default background
    ...
    .color = {
        ...
        0x303030, 0xf92673, 0x86b413, 0xfdb436, 0x55c5d6, 0x8952fe, 0x899ca1, 0xccccc7,
        0x848787, 0xff5996, 0xb8e354, 0xfeed6a, 0x8ceeff, 0x9c6efe, 0xa9bcc1, 0xf2f2f2,
